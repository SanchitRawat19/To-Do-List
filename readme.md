...
🏃‍♂️ Running the Application: Start the development server using Uvicorn:

Bash
uvicorn main:app --reload

i) Web Interface: Open your browser and navigate to http://127.0.0.1:8000/
ii) API: Access the raw API data at http://127.0.0.1:8000/api/tasks
...
🧪 Testing: This project uses pytest for automated testing of API endpoints.
...
NOTE: Tests are located in test_main.py and cover both the API response status codes and data validation.
...
☁️ Deployment: This application is ready for deployment on platforms like Render or Heroku.
...
👤 Author: Sanchit Rawat

GitHub Profile: https://github.com/SanchitRawat19
